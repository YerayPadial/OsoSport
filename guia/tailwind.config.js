...
export default {
 ...
 // --- COLORES OSCUROS ---
        ...
        'fondo-claro': 'var(--color-fondo-claro, #F4F6FB)',
        'tarjeta-clara': 'var(--color-tarjeta-clara, #FFFFFF)',
        'texto-claro': 'var(--color-texto-claro, #171923)',
        'texto-secundario-claro': 'var(--color-texto-secundario-claro, #5E6474)',
        'borde-claro': 'var(--color-borde-claro, #D8DCE6)',

        'dieta-ganar-claro': 'var(--color-dieta-ganar-claro, #2D62ED)',
        'dieta-perder-claro': 'var(--color-dieta-perder-claro, #D80458)',

        'surface': 'var(--color-surface, #11131B)',
        ...
        'on-surface': 'var(--color-on-surface, #E2E1ED)',
        'on-surface-muted': 'var(--color-on-surface-muted, #C3C5D7)',
        'outline-vanguard': 'var(--color-outline-vanguard, #434655)',
