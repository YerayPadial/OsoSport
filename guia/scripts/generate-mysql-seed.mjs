...
statements.push(`INSERT INTO users (username, email, first_name, last_name, display_name, role, password_hash, active) VALUES
${row(["ypadial", "ypadial@ososport.local", "Yeray", "Padial", "Yeray Padial", "admin", "$2y$12$ZaYy4AQnE.ZPF8r6FWTNx.J77/BNthE0yurCxQAdnzJewMUatzNUy", 1])},
${row(["chema", "chema@ososport.local", "Chema", "OsoSport", "Chema", "admin", "$2y$12$4XA20KPphey8ZRKwE6OZDOz9W.h28Vtqj8.UsaJN1PkPqPTcBmrdm", 1])};`);
